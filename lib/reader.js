...
Reader.prototype._onSubchunk1ID = function (chunk) {
  ...
  else if ('LIST' === subchunk1ID) {
    this._bytes(4, this._onInfoListSize);
  }
  else {
...
Reader.prototype._onInfoListSize = function (chunk) {
  debug('onInfoListSize: %o', chunk);
  var infoListChunkSize = chunk['readUInt32' + this.endianness](0);
  this._bytes(infoListChunkSize, function() {
    this._bytes(4, this._onSubchunk1ID);
  });
};
