...
prototype._onSubchunkFmt = function (chunk) {
  debug('onSubchunkFmt:', chunk);
  // TODO: support formats other than PCM?
  // lets do it!
  
  audioFormatCode = chunk['readUInt16' + this.endianness](0);
  debug('onSubhcunkFmt:', formats[audioFormatCode])
  if (formats[audioFormatCode])
  {
     this.audioFormat = formats[audioFormatCode]
  } else {
     this.audioFormat = 'Unknown';
  }
